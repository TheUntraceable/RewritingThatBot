...
class Slap(commands.Cog):
  ...
  async def stab(self,ctx,member:discord.Member=None):
    ...
    if member.id in [790525985266597918]:
      await ctx.send('LMAO imagine trying to slap me')
          ...
          im.paste(pfp2, (13, 35))
          im.save('stabbed.png')
          await ctx.send(file=discord.File('./images/stabbed.png'))
  ...
  async def rip(self,ctx,user:discord.Member=None):
    ...
    im = Image.open('./images/rip.png')
	
    im = im.copy()
    im.paste(user1, (372, 333))
    im.save('./images/killed.png')
    await ctx.send(file=discord.File('./images/killed.png'))
  ...
  async def admin(self,ctx,member1:discord.Member,member2:discord.Member,member3:discord.Member,member4:discord.Member,member5:discord.Member):
    ...
    im = Image.open('./images/admin.jpg')
